...
const baseTheme = {
  ...
  colors: {
    ...
    primaryTextColor: '#10244F',
    secondaryTextColor: '#173C67',
    primaryBlue: '#2A7BF4',
    darkCerulean: '#023F80',
    error: '#FF6464',
    ...
    skyBlue: '#1774CB',
    sierraBlue: '#0569FF',
    darkPurpureus: '#083B88',
    flashWhite: '#F8F8F0',
    indigo: 'rgba(5, 105, 255, 0.39)',
    brightYellow: '#FFC92B',
    dimYellow: '#FF6C07',
    darkPurple: '#10254F',
    navyBlue: '#1D78DA',
    antiFlashWhite: '#F0F0F8',
    secondaryVariants: [
  ...
  button: {
    ...
    loader: {
      white: getCDNUrl('/images/button/white_loader-1.gif'),
  ...
  gradients: {
    ...
    downloadPage: 'linear-gradient(180deg, #249CF2 0%, #0445A4 100%)',
    buttonBg: 'linear-gradient(180deg, #FFD600 0%, #FF6B00 100%)',
    downloadPageSecondFold:
      'radial-gradient(69.42% 96.06% at 50% 50%, #249CF2 0%, #0042A1 100%)',
